    ...
    return  Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: const Padding(
          ...
          child: CircleAvatar(backgroundImage: AssetImage(AppImage.profileImage),),
        ),
        ...
        children: [
          ...
          const SizedBox(height: AppSize.spaceBtnItems,),
           Padding(
            ...
            child: Text("Most Popular",style: Theme.of(context).textTheme.headlineMedium,),
          ),
          Padding(padding: const EdgeInsets.all(8.0),child: GridView.builder(shrinkWrap: true,physics: const ScrollPhysics(),gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2,mainAxisSpacing: 10,crossAxisSpacing: 10,mainAxisExtent: 230),itemCount: 10, itemBuilder: (con,index)=>ProductItem())),
          const SizedBox(height: AppSize.spaceBtnItems,),
